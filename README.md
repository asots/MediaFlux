...
- **Agent 发布格式教学**：在对话中提供真实样本，由 Agent 推导并预览，确认后保存复用，无需填写手动表单。教学规则不替代 TMDB 身份匹配与人工确认，详见[Agent 教学指南](docs/tutorials/10_发布格式教学.md)。
...
- 🎬 [**进阶教程专区**](docs/tutorials/)：
  ...
  - [通过 Agent 教学发布格式](docs/tutorials/10_发布格式教学.md)
